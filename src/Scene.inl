...
void Scene::init(void){
    ...
    node["bunny"] -> modeltransforms.push_back( scale(vec3(0.5f)) * translate(vec3(0.0f,1.0f,4.0f)) ); // The horizontal position of bunny is changed here
